...
$sql="select * from bloodpatients where id='$id'";
...
$data = $result->FETCH_ASSOC();
 ...
 <html >
    ...
    <div class="body"> <!--body-->
            ...
            <form action="modify1.php?id=<?= $id ?>" method="post" name="myForm" onsubmit="return validateForm()"> <!--edit form-->
            <div class="form_wrap">
              ...
              <div class="RESULT">
               ...
               <div class="type">
                 <div class="input_wrap">
                          ...
                          <label class="radio_wrap">
                            <input type="text" name="blood_type" class="input_radio" value="<?= $data['blood_type']?>"required>
 										 ...
 										 <div >
 											 <input type="submit" name="editform" value="submit" class="submit_btn" style="margin-top:10px; margin-bottom:-10px;">
 												...
 												<div >
 												<input type = "button" class="submit_btn" data-dismiss = "modal" value="cancel" onclick="window.location='bloodpatients.php'">
 	 											</div ><br>
 									 </div>
