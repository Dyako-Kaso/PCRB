...
/// create QRCODE
$pdf->write2DBarcode($_SERVER['HTTP_HOST'].'/blood/outputs/'.$id.'.pdf', 'QRCODE,M',  155, 235, 50, 50, $style, 'N');
$pdf->Output($_SERVER['DOCUMENT_ROOT'].'/wpnew/blood/outputs/'.$id.'.pdf', 'F');
