...
<body>
      ...
      <div class="body"> <!--body-->
      	...
      	<div class="New_Patient_Form">
      		...
      		<form method="post" action="insert2.php " name="myForm" onsubmit="return validateForm()" >
      			<div class="form_wrap">
         ...
         <div class="type">
           <div class="input_wrap">
                    ...
                    <select class="blood" name="blood_type">
                  ...
                  <div >
                      ...
                      <div >
                      <input type="button" value="cancel" onclick="window.location='bloodpatients.php'" class="submit_btn">
      				</div ><br>
      			</div>
      		</form>
      	</div>
