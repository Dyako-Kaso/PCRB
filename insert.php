...
$pdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
        ...
        $sql = "INSERT INTO pcrpatients(name,gender,phone,date_of_birth,date_of_test,date_of_issue,result) VALUES('$name' , '$gender','$phone',
...
/// create QRCODE
$pdf->write2DBarcode($_SERVER['HTTP_HOST'].'/wpnew/pcr/outputs/'.mysqli_insert_id($con).'.pdf', 'QRCODE,M',  155, 235, 50, 50, $style, 'N');



//Close and output PDF document
$pdf->Output($_SERVER['DOCUMENT_ROOT'].'/wpnew/pcr/outputs/'.mysqli_insert_id($con).'.pdf', 'F');
            echo '<script >alert("New patient has been added successfully!!")</script>';
