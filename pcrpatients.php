...
if(isset($_SESSION['pcr'])){
    header('Location: pcrpatients.php');
}
...
<body>
  ...
  <form method='post' action=""> <!--start of the form that will display the search bar
    (once the user enter anything in the search bar it will direct him to (model/tables/itemDetailsSearchCreator1.php))
...
<?php
include '../model/tables/itemDetailsSearchTableCreator1.php';
?>
